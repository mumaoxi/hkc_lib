...
public class UmengOnEventRequest extends FreshRequest<UmengOnEventResponse> {
	...
	public String getRequestBody() {
		...
		try {
			...
			eventObject
					.put("date", DateUtils.formatDate(dateNow, "yyyy-MM-dd"));
			eventObject.put("session_id",
					MD5.encrypt(device_id + System.currentTimeMillis())
							.toUpperCase(Locale.CHINA));
			eventObject.put("time", DateUtils.formatDate(dateNow, "HH:mm:ss"));
			/**
			 * 点击次数
			 */
	...
	@Override
	public Class<UmengOnEventResponse> getResponseClass() {
		return UmengOnEventResponse.class;
	}
