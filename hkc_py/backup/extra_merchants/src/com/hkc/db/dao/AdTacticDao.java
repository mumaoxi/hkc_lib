    ...
    public boolean addAdTactic(AdTactic tactic) {
        ...
        synchronized (AdTacticDao.class) {
            ...
            try {
                ...
                values.put(
						"advertisement_ids",
						tactic.getAdvertisement_ids() != null ? Arrays
								.toString(tactic.getAdvertisement_ids()) : "");
    ...
    public List<AdTactic> getUnReadedTacticsList() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                tactic.setAdvertisement_ids(NumUtils.stringToIntArray(cursor
						.getString(cursor.getColumnIndex("advertisement_ids"))));
